...
{{-- Menambahkan style kustom untuk menyesuaikan warna dengan logo --}}
@push('custom-css')
<style>
    /* Skema warna baru yang terinspirasi dari logo SILAGA */
    :root {
        --primary-blue: #2563EB; /* Biru utama dari logo */
        --dark-blue: #1E3A8A;   /* Biru tua untuk teks dan header */
        --secondary-gray: #6B7280; /* Abu-abu untuk tombol sekunder */
        --light-gray: #F9FAFB;   /* Abu-abu sangat terang untuk latar */
        --success-green: #10B981; /* Hijau untuk status sukses */
        --danger-red: #EF4444;    /* Merah untuk status error/peringatan */
    }
    ...
    /* Menyesuaikan warna header kartu agar serasi dengan teks logo */
    .card-header {
        color: var(--dark-blue);
        font-weight: 600;
    }

    /* Menyesuaikan warna teks span yang menggunakan class .text-primary */
    .text-primary {
    ...
    /* Memberi warna border pada input form saat aktif/fokus */
    .form-control:focus, .form-select:focus {
        border-color: var(--primary-blue) !important;
        box-shadow: 0 0 0 0.25rem rgba(37, 99, 235, 0.25) !important;
    }
    
    /* Mengubah warna tautan/link */
    a {
                ...
                <h5 class="card-header">Profile Details
                    @if($user->role_id == 3)
                        @if($user->details?->status)
                            {{-- Menggunakan warna hijau untuk status yang disetujui --}}
                            <span style="color: var(--success-green); font-weight: 400;">( {{ $user->details?->status_info }} )</span>
                        @else
                             {{-- Menggunakan warna merah untuk status yang belum disetujui/ditolak --}}
                            <span class="text-danger" style="font-weight: 400;">( {{ $user->details?->status_info }} )</span>
                        @endif
                    @endif
                </h5>
                <!-- Account -->
