<div class="modal-header" style="background: #2E63A2; color: #fff;">
    <h5 class="modal-title" id="modalToggleLabel" style="color: #fff;">{{ $user->name }}</h5>
    @if (!$user->details)
        <span class="text-danger" style="color: #ffd6d6;">(This user not completed their profile)</span>
    @endif
...
<div class="modal-footer">
    ...
    <form action="{{ route('dashboard.users.verifyAction', ['id' => $user->user_id]) }}" method="POST">
        @csrf
